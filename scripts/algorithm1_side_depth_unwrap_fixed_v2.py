...
def _unwrap_from_depth_arc(
    ...
    report = {
        ...
        "notes": [
            ...
            "Depth gradients still redistribute x samples within each row.",
        ],
    }
    return {
...
def run(
    ...
    report: dict[str, Any] = {
        ...
        "method": "Algorithm 1 canonical 3D surface -> fixed-view projection with z-buffer -> per-view depth maps -> normalized depth-arc side unwrap",
